                ...
                <div className="layer">
                    ...
                    <div className="info">
                        ...
                        <div className="buttonsProject">
                            <a href={code} target="_blank" rel="noopener noreferrer" className="btn code">Código</a>
                            <a href={app} target="_blank" rel="noopener noreferrer" className="btn view">Ver</a>
                            <Link to={`/`} className="btnBack">Ir atrás</Link>
                        </div>
                    </div>
